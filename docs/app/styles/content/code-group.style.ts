export const useCodeGroupStyle = createVariants({
  slots: {
    ...
    indicator: 'abs z-1 h-8 left-0 inset-y-2 bg-accent-4 rounded-lg w-$reka-tabs-indicator-size transition-[transform,width] duration-200 ease-in-out translate-x-$reka-tabs-indicator-position',
